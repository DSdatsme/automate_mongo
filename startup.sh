...
--metadata=email=darshitkumar.suratwala@quantiphi.com,office-time=Mumbai-10,startup-script=sudo\ gsutil\ cp\ gs://darshit-source/q.sh\ /mnt$'\n'sudo\ chmod\ \+x\ /mnt/q.sh$'\n'sudo\ bash\ /mnt/q.sh
...
touch yes1.txt
gsutil cp yes1.txt gs://darshit-source
a=1

...
#create instance
gcloud compute instances create $INSTANCE_NAME --zone $ZONE --machine-type=n1-standard-1
...
gcloud compute ssh --zone=us-east1-b b-instance --command 'mkdir /mnt/okay'
###################disk attaching
#disk attach
